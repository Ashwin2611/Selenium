...
public class ReadFile {
	...
	public static Properties Properties() throws IOException {
		...
		InputStream input=new FileInputStream("C:\\Users\\ashwin.murugan\\eclipse-workspace\\Supertails\\src\\test\\java\\com\\ashwin\\Supertails\\Supertails.properties");
		prob.load(input);
		return prob;
	}
